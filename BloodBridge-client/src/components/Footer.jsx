      ...
      <div className="grid gap-12 md:grid-cols-3">
        <div>
          <Link to="/" className="flex items-center gap-3">
            <div
              className="w-9 h-9 bg-[#D62828] flex items-center justify-center text-white"
              style={{
                clipPath:
                  "polygon(50% 0%, 85% 35%, 100% 55%, 85% 75%, 50% 100%, 15% 75%, 0% 55%, 15% 35%)",
              }}
            >
              B
            </div>
            <span
              className="text-xl font-bold tracking-[3px] text-[#F5E6E0]"
